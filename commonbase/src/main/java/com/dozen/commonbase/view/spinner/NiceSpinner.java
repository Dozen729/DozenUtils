...
public class NiceSpinner extends AppCompatTextView {
    ...
    private NiceSpinnerBaseAdapter<Object> adapter;
    ...
    private int backgroundSelector = R.drawable.selector;
    private int itemBackground = R.drawable.spinner_item_background;
    private int dropDownBackground = R.drawable.spinner_drop_down_background;
    ...
    private SpinnerTextFormatter<Object> spinnerTextFormatter = new SimpleSpinnerTextFormatter();
    private SpinnerTextFormatter<Object> selectedTextFormatter = new SimpleSpinnerTextFormatter();
...
//                    post(this::showDropDown);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        setPadding(resources.getDimensionPixelSize(R.dimen.three_grid_unit), defaultPadding, defaultPadding,
                defaultPadding);
        setClickable(true);
        backgroundSelector = typedArray.getResourceId(R.styleable.NiceSpinner_backgroundSelector, backgroundSelector);
        setBackgroundResource(backgroundSelector);

        itemBackground = typedArray.getResourceId(R.styleable.NiceSpinner_itemBackgroundChange, R.drawable.spinner_item_background);
        ...
        dropDownBackground = typedArray.getResourceId(R.styleable.NiceSpinner_dropDownBackground, dropDownBackground);
        popupWindow.setBackgroundDrawable(getResources().getDrawable(dropDownBackground));
    ...
    public <T> void attachDataSource(@NonNull List<T> list) {
        adapter = new NiceSpinnerAdapter<>(getContext(), list, textColor, itemBackground, spinnerTextFormatter, horizontalAlignment);
        setAdapterInternal(adapter);
    }

    public void setAdapter(ListAdapter adapter) {
        this.adapter = new NiceSpinnerAdapterWrapper(getContext(), adapter, textColor, itemBackground,
