...
public class AgentWebFragment extends Fragment implements FragmentKeyDown {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.agent_fragment_agentweb, container, false);
    }
...
//		mAgentWeb.getWebCreator().getWebView().setOnLongClickListener();
    ...
    public class AndroidJs {
        ...
        @JavascriptInterface
        public void click_to_see_details(String msg) {
            if (CommonConstant.umeng_click) {
                Map<String, String> map = new HashMap<String, String>();//统计埋点
                map.put("click", msg);
                MobclickAgent.onEvent(getActivity(), "click_to_see_details", map);
            }
...
//        mAgentWeb.uploadFileResult(requestCode, resultCode, data);
    ...
    protected void initView(View view) {
        ...
        pageNavigator(View.GONE);
        mMoreImageView.setVisibility(menuShow?View.VISIBLE:View.INVISIBLE);
    }

    public void setMenuState(boolean show){
        menuShow = show;
    }
