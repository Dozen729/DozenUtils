...
//        MobclickAgent.reportError(mContext, ex);//友盟
        handleException(ex);
    ...
    public Map<String, String> collectDeviceInfo(Context ctx) {
        ...
        try {
            ...
            MyLog.e("an error occured when collect package info"+ e);
        }
        ...
        for (Field field : fields) {
            try {
                ...
                MyLog.e("an error occured when collect crash info"+ e);
            }
        }
        return infos;
    }
     ...
     */
    private String saveCrashInfo2File(Map<String, String> infos, Throwable ex) {
        MyLog.e("saveCrashInfo2File"+ ex);
        ...
        try {
            ...
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                String path = SystemUtils.getSDPath() + "/crash/";
