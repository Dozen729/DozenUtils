...
public class StyleToastUtil {
    ...
    public static void normal(@NonNull String message) {
        normal(APPBase.getApplication(), message, Toast.LENGTH_SHORT, null, false).show();
    }

    public static void normal(@NonNull String message, Drawable icon) {
        normal(APPBase.getApplication(), message, Toast.LENGTH_SHORT, icon, true).show();
    }

    public static void normal(@NonNull String message, int duration) {
        normal(APPBase.getApplication(), message, duration, null, false).show();
    }

    public static void normal(@NonNull String message, int duration, Drawable icon) {
        normal(APPBase.getApplication(), message, duration, icon, true).show();
    }

    public static Toast normal(@NonNull String message, int duration, Drawable icon, boolean withIcon) {
        return custom(APPBase.getApplication(), message, icon, DEFAULT_TEXT_COLOR, duration, withIcon);
    }

    public static void warning(@NonNull String message) {
        warning(APPBase.getApplication(), message, Toast.LENGTH_SHORT, true).show();
    }

    public static void warning(@NonNull String message, int duration) {
        warning(APPBase.getApplication(), message, duration, true).show();
    }

    public static Toast warning(@NonNull String message, int duration, boolean withIcon) {
        return custom(APPBase.getApplication(), message, getDrawable(APPBase.getApplication(), R.drawable.ic_error_outline_white_48dp), DEFAULT_TEXT_COLOR, WARNING_COLOR, duration, withIcon, true);
    }
    ...
    public static void info(@NonNull String message) {
        ...
        info(APPBase.getApplication(), message, Toast.LENGTH_SHORT, true).show();
    }

    public static void info(@NonNull String message, int duration) {
        info(APPBase.getApplication(), message, duration, true).show();
    }

    public static Toast info(@NonNull String message, int duration, boolean withIcon) {
        return custom(APPBase.getApplication(), message, getDrawable(APPBase.getApplication(), R.drawable.ic_info_outline_white_48dp), DEFAULT_TEXT_COLOR, INFO_COLOR, duration, withIcon, true);
    }

    public static void success(@NonNull String message) {
        success(APPBase.getApplication(), message, Toast.LENGTH_SHORT, true).show();
    }

    public static void success(@NonNull String message, int duration) {
        success(APPBase.getApplication(), message, duration, true).show();
    }

    public static Toast success(@NonNull String message, int duration, boolean withIcon) {
        return custom(APPBase.getApplication(), message, getDrawable(APPBase.getApplication(), R.drawable.ic_check_white_48dp), DEFAULT_TEXT_COLOR, SUCCESS_COLOR, duration, withIcon, true);
    }
    ...
    public static void error(@NonNull String message) {
        ...
        error(APPBase.getApplication(), message, Toast.LENGTH_SHORT, true).show();
    }
    ...
    public static void error(@NonNull String message, int duration) {
        error(APPBase.getApplication(), message, duration, true).show();
    }

    public static Toast error(@NonNull String message, int duration, boolean withIcon) {
        return custom(APPBase.getApplication(), message, getDrawable(APPBase.getApplication(), R.drawable.ic_clear_white_48dp), DEFAULT_TEXT_COLOR, ERROR_COLOR, duration, withIcon, true);
    }
    ...
    public static void showToastShort(String str) {
        Toast.makeText(APPBase.getApplication(), str, Toast.LENGTH_SHORT).show();
    }
    ...
    public static void showToastShort(int resId) {
        Toast.makeText(APPBase.getApplication(), APPBase.getApplication().getString(resId), Toast.LENGTH_SHORT).show();
    }
    ...
    public static void showToastLong(String str) {
        Toast.makeText(APPBase.getApplication(), str, Toast.LENGTH_LONG).show();
    }
    ...
    public static void showToastLong(int resId) {
        Toast.makeText(APPBase.getApplication(), APPBase.getApplication().getString(resId), Toast.LENGTH_LONG).show();
    }
    ...
    public static void showToast(String msg) {
        ...
        mToast = Toast.makeText(APPBase.getApplication(), msg, Toast.LENGTH_LONG);
        mToast.show();
    }
    ...
    public static void showToast(int resId) {
        ...
        mToast = Toast.makeText(APPBase.getApplication(), APPBase.getApplication().getString(resId), Toast.LENGTH_LONG);
        mToast.show();
    }
