...
public class BindPhoneActivity extends CommonActivity {
    ...
    protected int setLayout() {
        return R.layout.activity_bind_phone_dozen;
    }
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        if (EmptyCheckUtil.isEmpty(sign)){
            finish();
            return;
        }
    ...
    protected void initData() {
        smsCodeUtil=new SMSCodeUtil(this, getResources().getColor(R.color.login_code_text), Color.parseColor("#979797"),tvCodeVerification,120);
    }
...
//            }
    ...
    private void bindPhone(String phone,String sms){
        LoginUserHttpUtils.bindPhone(sign, phone, sms, new CallBack() {
            @Override
            public void onRequested(ResultInfo info, Object tag) {
                if (info.isSucceed()&&tag.equals("bindPhone")){
